...
export const maps: {[id: string]: [number[][], string, string?, string?, string?]} = {
  ...
  "04": [roadout, "After the gig", "They broke a leg! Looks like you're everyone again, get the stuff in the van", "Can't wait to get to the hotel for a beer with the crew!"],
  "05": [sokoban1, "Warehouse blues", "You're itching to play, but the rest of the band locked the door. You set up your guitar in some storage space.", "Wonder what the guys were giggling about in there..."],
  "06": [sokoban2, "Blind trial", "You take a side job for a scientific study on telepathic guitarists playing in time. One of them looks like a bassist, though.", "Wow, they really are in time!"],
  "07": [sokoban3, "Dancehall", "You get to arrange the seating now, too!", "You feel useful."],
  "08": [alone3, "Warehouse swing", "Tidying up for another gig, you have a minute to practice.", "\"Nobody knows the trouble I've seen\"..."],
  "09": [sokobanStar, "Wedding gig", "The band's a surprise. You're running the cables discreetly.", "The bride was in tears! You have something in your eye, too."],
  "10": [pureban, "Dayjob", "You can't concentrate at work. The gig's all you can think about", "You've memorized all of the songs just in case"],
  "11": [familiar, "Somehow familiar", "Until you're reminded of something faintly familiar", ""],
  "12": [Vinni, "Penthouse", "This is it! The final gig! The hall's going to be packed!", "What a tour! If only you got to play..."],
  //"91": doubleRockTest,
  //"92": rockOnCableTest,
  //"99": [EndScreen, ""],
};
